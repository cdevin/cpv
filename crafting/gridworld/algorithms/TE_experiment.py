...
import numpy as np
import copy
from gridworld.algorithms.composite_models import TaskEmbeddingModel
...
model = TaskEmbeddingModel(device,task_embedding_dim=args.feature_dim).to(device)
...
if __name__ == "__main__":
    filename = 'TE_4tasks'+hl_str+pl_str+'_images_feat'+str(args.feature_dim)+'_'+args.letter+'_{:06d}'.format(args.train_size)
